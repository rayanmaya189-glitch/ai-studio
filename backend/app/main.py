...
from app.api import agents, chat, projects, providers, rag, scan, tasks, edit, pull_requests
...
for router in (projects, scan, chat, agents, tasks, providers, rag, edit, pull_requests):
